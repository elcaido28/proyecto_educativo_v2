<?php
    ...
    $idcurso=$_REQUEST['idc'];
    $consulta="SELECT * FROM curso C WHERE C.id_curso='$idcurso'";
                                  ...
                                  <div id="empleados">
                                      ...
                                      <div class="x_content">
                                          <div class="table-responsive">
                                              <!-- ajax -->
                                              <form id="formulario" class="formulario" action="modificar_curso.php?id=<?php echo $idcurso; ?>" method="post" enctype="multipart/form-data">
                                                <fieldset class="fieldset_normal">
                                                  ...
                                                  <input type="txt" name="curso" value="<?php echo $row['curso'];?>" placeholder="" onkeypress="return sololetras(event)" onpaste="return false">
                                                  </div>
