...
<?php
    ...
    $peri="";
    $cur="";
    if (isset($_POST['quime']) && isset($_POST['parcial']) && isset($_POST['periodo']) && isset($_POST['curso'])) {
      $pace=$_POST['parcial'];
      $quime=$_POST['quime'];
      $peri=$_POST['periodo'];
      $cur=$_POST['curso'];
        ...
        <div class="">
            <div class="page-title">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_panel">
                      <div class="x_title">
                          <h2>Vista de notas por parcial &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h2>   <a href="reporte_libreta_impri2.php?id_peri=<?php echo $peri; ?>&id_cur=<?php echo $cur; ?>" target="_blank">  <h2> IMPRIMIR NOTAS <i class="fas fa-print"></i></h2></a>
                      ...
                      <div class="x_content">
                          <div class="table-responsive">
                            <form id="formulario" class="formulario" action="vista_libreta2.php" method="post" enctype="multipart/form-data">
                      ...
                      <?php
                          ...
                          $ejec0=mysqli_query($con,"SELECT * FROM matricula M inner join estudiante E on E.id_estudiante=M.id_estudiante INNER JOIN notas N ON N.id_matricula=M.id_matricula WHERE M.id_curso_periodo='$cur' and M.id_periodo='$peri'");
                          while($row0=mysqli_fetch_array($ejec0)){
                          $id_curso_periodo=$row0['id_curso_periodo'];
                          $id_notas=$row0['id_notas'];
                          $Id_perido=$row0['id_periodo'];
                          $Id_estudiante=$row0['id_estudiante'];
                          $Nom_estudiante=$row0['apellidos']." ".$row0['nombres'];

 echo "<br><br><h1>ESTUDIANTE: ".$Nom_estudiante."</h1>";
