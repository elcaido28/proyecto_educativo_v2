                      ...
                      <script src="jquery.dataTables.min.js" charset="utf-8"></script>
                                ...
                                $consulta=mysqli_query($con,"SELECT * from periodo order by id_periodo ASC ");
                                 while($row=mysqli_fetch_array($consulta)){
                                  ...
                                  $idprofe=$_SESSION['CEDU'];
                                $consulta2=mysqli_query($con,"SELECT * from curso_periodo CP inner join curso C on C.id_curso=CP.id_curso inner join paralelo P on P.id_paralelo=CP.id_paralelo inner join pre_planificacion PPL on PPL.id_curso_periodo=CP.id_curso_periodo where CP.id_periodo='$idperiodo' and PPL.cedula_profesor='$idprofe'  ");
