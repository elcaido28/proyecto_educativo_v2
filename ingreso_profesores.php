                  ...
                  <div class="x_panel">
                      ...
                      <div class="x_content">
                          <div class="table-responsive">
                              <!-- ajax -->
                              <form id="formulario" class="formulario" action="guardar_profesores.php" method="post" enctype="multipart/form-data">
                        ...
                        <table class="tabla" >
                            <thead>
                              ...
                              <tr>
                                ...
                                $consulta=mysqli_query($con,"SELECT * from Profesor P  WHERE P.id_estado='1' ORDER BY fecha DESC ");
                                ...
                                ?>
                                      ...
                                      <td> <a href="ingreso_asig_mate_profe.php?id=<?php echo $row['id_profesor'] ?>"><button type="button" title="Modificar" class="modificar" name="button"><i class="far fa-share-square"></i></button></a> </td>
                                      <td> <div class="cont_tbn_tb"><a href="editar_profesor.php?idp=<?php echo $row['id_profesor']; ?>"><button type="button" title="Modificar" class="modificar" name="button"><i class="far fa-edit"> </i></button></a>
                          ...
                          <script type="text/javascript">
                            $('.eliminar').click(function(e){
                             if (confirm("¿Está segur@ de ELIMINAR?")){
                                document.location.href="eliminar_profesor.php?id=<?php echo $row['id_profesor'];?>";
                              }else{
                                document.location.href="ingreso_profesores.php";
                              }
                            })
                          </script>
