                  ...
                  <div class="x_panel">
                      ...
                      <div class="x_content">
                          <div class="table-responsive">
                              <!-- ajax -->
                              <form id="formulario" class="formulario" action="guardar_estudiantes.php" method="post" enctype="multipart/form-data">
                                <fieldset class="fieldset_normal">
                                  ...
                                  <div class="cont_cajas_peque">
                                    ...
                                    <input type="text" id="cedula" name="cedula" value="" placeholder="" maxlength="10" onkeypress="return solonumeroRUC(event)" >
                                  </div>
                                  <div class="cont_cajas_peque">
                              ...
                              <script type="text/javascript">
                                function fecha_edad() {
                                    ...
                                    var mayor=parseInt(ano)+5;
                                    if (mayor>ano_actual) {
                                      alert("Tiene que ser Mayor a 5 años");
                        ...
                        <table class="tabla" >
                            <thead>
                              ...
                              <tr>
                                ...
                                $consulta=mysqli_query($con,"SELECT * from estudiante WHERE id_estado='1' ORDER BY fecha DESC ");
                                ...
                                ?>
                                      ...
                                      <td> <a href="ingreso_representante.php?id=<?php echo $row['id_estudiante'] ?>"><button type="button" title="Modificar" class="modificar" name="button"><i class="far fa-share-square"></i></button></a> </td>
